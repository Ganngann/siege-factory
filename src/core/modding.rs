...
/// Helper function to prevent path traversal attacks by validating that the requested
/// path does not contain parent directory (`..`), root directory (`/`), or prefix components.
